	...
	public void PranoEmail(ActionEvent event) {
		...
		if (UserID.equals("")) {
			...
			try {
				...
				String sql = "Select * from perdoruesit where pid=" + id.getText() + "";
	...
	void Reset(ActionEvent event) {
		...
		if (email == true) {
			...
			if (eCode.equals("") || nPass.equals("") || cPass.equals("")) {
				...
				try {
					String sql = "Update perdoruesit set pfjalekalimi='" + fjalekalimi + "',psalt='" + salt
